...
jQuery(function(){
   jQuery("div.svwp").prepend("<img src='"+window.imageDirectoryURL+"/images/loader.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path   
});
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	...
	return this.each(function(){
		...
		var pictWidth = container.find("img").attr("width"); // JB debug
		var pictHeight = container.find("img").attr("height"); // JB debug
    ...
    .wrap(jQuery("<div style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0'>"));
		...
		container.each(function(i) {
			...
			jQuery(this).find("img").each(function(z) {
				...
				var imgWidth = jQuery(this).attr("width"); // JRL debug
				jQuery(this).after("<span class='typo' style='position: absolute; width:"+(imgWidth-12)+"px; margin: 0 0 0 -"+imgWidth+"px'>"+jQuery(this).attr("alt")+"<\/span>"); // JRL debug
			});
			}
